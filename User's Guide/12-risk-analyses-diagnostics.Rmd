...
```{r figure-143, echo=FALSE, fig.cap="Example of integration diagnostics.", fig.align="center"}
...
```{r figure-144, echo=FALSE, fig.cap="Select the risk type and risk measure to display results.", fig.align="center"}
...
```{r figure-145, echo=FALSE, fig.cap="Risk measure diagnostic tools in RMC-TotalRisk showing the kernel density of the excess mean loss, E[C].", fig.align="center"}
...
```{r figure-146, echo=FALSE, fig.cap="Example of a risk profile plot showing the hazard exceedance probability for the background risk at Dam A.", fig.align="center"}
...
```{r figure-147, echo=FALSE, fig.cap="Example of a risk profile plot showing the hazard exceedance probability for the excess risk at Dam A.", fig.align="center"}
...
```{r figure-148, echo=FALSE, fig.cap="Example risk diagram for a levee risk analysis.", fig.align="center"}
...
```{r figure-149, echo=FALSE, fig.cap="Setting the profile hazard type and threshold level for the system component.", fig.align="center"}
...
```{r figure-150, echo=FALSE, fig.cap="Example of the cumulative distribution plot for NFIP assurance.", fig.align="center"}
...
```{r figure-151, echo=FALSE, fig.cap="Example of a tornado plot for risk diagnostics.", fig.align="center"}
...
```{r figure-152, echo=FALSE, fig.cap="Example of a X-Y plot for risk diagnostics.", fig.align="center"}
...
```{r figure-153, echo=FALSE, fig.cap="Tabular diagnostics tab displays every Monte Carlo realization for the selected risk type and risk measure.", fig.align="center"}
...
```{r figure-154, echo=FALSE, fig.cap="Example of the histogram and summary statistics output for tabular results.", fig.align="center"}
