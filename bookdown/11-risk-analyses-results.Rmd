...
```{r figure-136, echo=FALSE, fig.cap="Risk results tabs.", fig.align="center"}
...
```{r figure-137, echo=FALSE, fig.cap="Select checkboxes for risk type and the system component in the graphical and tabular risk results.", fig.align="center"}
...
```{r figure-138, echo=FALSE, fig.cap="Tolerable risk guideline viewing options for graphical risk results in RMC-TotalRisk.", fig.align="center"}
...
```{r figure-139, echo=FALSE, fig.cap="Example of Loss Exceedance Plot results with confidence intervals and the USACE TRL.", fig.align="center"}
...
```{r figure-140, echo=FALSE, fig.cap="Tolerable Risk Limit Editor.", fig.align="center"}
...
```{r figure-141, echo=FALSE, fig.cap="Conditional Loss Plot displaying excess risk results as the probability of failure and the conditional mean life loss, showing USACE Tolerable Risk Limits as dotted black lines.", fig.align="center"}
...
```{r figure-142, echo=FALSE, fig.cap="Risk analysis results on the Summary Statistics tab in RMC-TotalRisk.", fig.align="center"}
