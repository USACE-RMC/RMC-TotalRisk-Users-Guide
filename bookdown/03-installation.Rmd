...
```{r figure-1, echo=FALSE, fig.cap="RMC-TotalRisk executable file in the RMC-TotalRisk portable .zip directory.", fig.alt="Windows file explorer directory containing the RMC-TotalRisk executable.", fig.align="center"}
...
```{r figure-2, echo=FALSE, fig.cap="Right-click to select how to open a file in Windows.", fig.alt="Right-click context menu in Windows used to set the file association.", fig.align="center"}
...
```{r figure-3, echo=FALSE, fig.cap="RMC-TotalRisk project with file association in Windows.", fig.alt="Windows file explorer displaying the correct icon associated with RMC-TotalRisk.", fig.align="center"}
